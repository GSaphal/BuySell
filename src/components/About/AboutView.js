      ...
      <div className="container">
        <div className="row justify-content-md-center">
          <div className="col col-lg-12 col-xl-8">
            ...
            <h4 className="title">Why do you do what you do?</h4>
            <p>
            ...
            <p>
              ...
              ligula, eget lacinia odio sem nec elit. Donec sed odio dui.
            </p>
            <h4 className="title">Who are the people behind the company?</h4>
            <p>
              Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis
              natoque penatibus et magnis dis parturient montes, nascetur
              ridiculus mus. Nullam id dolor id nibh ultricies vehicula ut id
            ...
            <h4 className="title">What does your company stand for?</h4>
            <p>
              Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis
              natoque penatibus et magnis dis parturient montes, nascetur
              ridiculus mus. Nullam id dolor id nibh ultricies vehicula ut id
